...
class SourceOperate extends PureComponent {
  ...
  onFinish = (formData) => {
    ...
    formData.goSource = () => {
      ...
      const pageParams = { pathname: "/source" };
      if (params) {
      ...
      <div>
        ...
        >
          <Form.Item
            label="学习资源分类"
            name="sourceCategory"
            rules={[{ required: true, message: "请选择学习资源分类" }]}
          >
          ...
          <Form.Item
            ...
            rules={[
              ...
              { whitespace: true, message: "请输入正确的学习资源标题" },
              {
                type: "string",
                max: 20,
                message: "请输入正确的学习资源标题(不超过20个字符)",
              },
            ]}
          >
            <Input
              disabled={isLook}
              placeholder="请输入学习资源标题，不超过20个字符"
            ></Input>
          </Form.Item>
          <Form.Item label="logo链接" name="logo">
            <Input
              disabled={isLook}
              placeholder="请输入学习资源logo链接"
            ></Input>
          </Form.Item>
          <Form.Item
            label="资源地址"
