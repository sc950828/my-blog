...
// source category
export const GET_SOURCE_CATEGORY_LISTS = "get_source_category_lists"
export const GET_SOURCE_CATEGORY_LISTS_SUCCESSED = "get_source_category_lists_successed"
export const GET_SOURCE_CATEGORY_LISTS_FAILED = "get_source_category_list_failed"
export const GET_ALL_SOURCE_CATEGORY_LISTS = "get_all_source_category_lists"
export const GET_ALL_SOURCE_CATEGORY_LISTS_SUCCESSED = "get_all_source_category_lists_successed"
export const GET_ALL_SOURCE_CATEGORY_LISTS_FAILED = "get_all_source_category_list_failed"
export const GET_SOURCE_CATEGORY = "get_source_category"
export const GET_SOURCE_CATEGORY_SUCCESSED = "get_source_category_successed"
export const GET_SOURCE_CATEGORY_FAILED = "get_source_category_failed"
export const ADD_SOURCE_CATEGORY = "add_source_category"
export const UPDATE_SOURCE_CATEGORY = "update_source_category"
export const DELETE_SOURCE_CATEGORY = "delete_source_category"
export const CHANGE_SOURCE_CATEGORY_STATUS = "change_source_category_status"

// source
export const GET_SOURCE_LISTS = "get_source_lists"
export const GET_SOURCE_LISTS_SUCCESSED = "get_source_lists_successed"
export const GET_SOURCE_LISTS_FAILED = "get_source_lists_failed"
export const GET_SOURCE = "get_source"
export const GET_SOURCE_SUCCESSED = "get_source_successed"
export const GET_SOURCE_FAILED = "get_source_failed"
export const ADD_SOURCE = "add_source"
export const UPDATE_SOURCE = "update_source"
export const DELETE_SOURCE = "delete_source"
export const CHANGE_SOURCE_STATUS = "change_source_status"
