...
- 方法
  - 采用 transform: scaleY()或者 scaleX() 的方式。根据dpr来设置缩写比。
  - 采用 meta viewport 的方式。当 dpr 是 2 的时候，可以使用该方法的 initial-scale 初始缩放 0.5 倍。当 dpr 是 3 的时候 initial-scale 初始缩放 0.33 倍。根据dpr来设置缩写比。
